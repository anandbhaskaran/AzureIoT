# Commands for Azure Powershell:
#  Retrieve your Hub details:
#   az iot hub device-identity show-connection-string --device-id colibri-imx8x --hub-name Toradex-test-hub

#  Initiate listening:
#   az iot hub monitor-events --hub-name Toradex-test-hub --output table

#  Communicate with the Device
#   az iot device c2d-message send --device-id colibri-imx8x --hub-name Toradex-test-hub --data "Hello! This is Janani"
